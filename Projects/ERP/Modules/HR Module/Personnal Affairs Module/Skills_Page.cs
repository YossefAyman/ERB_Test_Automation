...
namespace ERP_Automation_Testing
{
    public class Skills_Page
    {
        ...
        static By SkillName =                           By.Id("Skill_SkillName");
        static By SkillDescription =                    By.Id("Skill_SkillDescription");
        ...
        public static void Add_Skill()
        {
            ...
            Driver.FindElement(SkillName).SendKeys(Data.M1HR.Skills_Name);
            Driver.FindElement(SkillDescription).SendKeys(Data.M1HR.Skills_Dec);
            Driver.FindElement(Save_Button).Click();
            time.Sleep(3000);
        }

        public static void Edit_Skill(string skill)
        {
            Search(Data.M1HR.Skills_Name);
            Driver.FindElement(Edit_Button).Click();
            Driver.FindElement(SkillName).Clear();
            Driver.FindElement(SkillName).SendKeys(skill);
            Driver.FindElement(SkillDescription).Clear();
            Driver.FindElement(SkillDescription).SendKeys(Data.M1HR.Skills_Dec + "_Edited");
            Driver.FindElement(Save_Button).Click();
            time.Sleep(3000);
        }

        public static void Delete_Skill(string Skill)
        {
            Search(Skill);
