...
{
    public class ReasonsForFinancialDisclosure_Page
    {
        ...
        static By FinancialReceivablesApplyReason_Name =             By.Id("FinancialReceivablesApplyReason_Name");
        ...
        {
            Pages.ReasonsForFinancialDisclosurePage();
            time.Sleep(2000);

        }

        public static void Add_ReasonForFinancialDisclosure()
        {
            Driver.FindElement(Add_Button).Click();
            Driver.FindElement(FinancialReceivablesApplyReason_Name).SendKeys(Data.M1HR.ReasonForFinancialDisclosure);
            Driver.FindElement(Save_Button).Click();
            time.Sleep(2000);
        }

        public static void Edit_ReasonForFinancialDisclosure(string ReasonForFinancialDisclosure)
        {
            Search(Data.M1HR.ReasonForFinancialDisclosure);
            Driver.FindElement(Edit_Button).Click();
            Driver.FindElement(FinancialReceivablesApplyReason_Name).Clear();
            Driver.FindElement(FinancialReceivablesApplyReason_Name).SendKeys(ReasonForFinancialDisclosure);
            Driver.FindElement(Save_Button).Click();
            time.Sleep(2000);
        }

        public static void Delete_ReasonForFinancialDisclosure(string ReasonForFinancialDisclosure)
        {
            Search(ReasonForFinancialDisclosure);
