...
{
    public class EmploymentType_Page
    {
        ...
        static By WorkplaceType_Name =      By.Id("WorkplaceType_Name");
        static By Save_Button =             By.XPath("//input[@value='حفظ']");
        static By Search_TextBox =          By.XPath("//*[@id=\"workplaceTypeController\"]/div[2]/section/div/div/div[2]/div/div/div[1]/div[1]/div/input");
        static By Search_Button =           By.XPath("//*[@id=\"workplaceTypeController\"]/div[2]/section/div/div/div[2]/div/div/div[1]/div[1]/div/span/button");
        ...
        public static void Add_EmploymentType()
        {
            ...
            Driver.FindElement(WorkplaceType_Name).SendKeys(Data.M1HR.Employment_Type_Name);
        ...
        {
            Search(Data.M1HR.Employment_Type_Name);
            Driver.FindElement(Edit_Button).Click();
            Driver.FindElement(WorkplaceType_Name).Clear();
            Driver.FindElement(WorkplaceType_Name).SendKeys(EmploymentType);
            Driver.FindElement(Save_Button).Click();
            time.Sleep(2000);
        }
