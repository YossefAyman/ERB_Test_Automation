...
{
    public class LeasedProperties_Report
    {
        ...
        public static void Goto()
        {
            ...
            Driver.FindElements(Owner_PropertyReport)[7].Click();
            time.Sleep(2000);
        ...
        public static bool Check_That_Property_Is_Added_Correctly_To_Leased_Properties()
        {
