...
{
    [TestFixture]
    class M2_General_Sittings_N2_Area_Test
    {
        [SetUp]
        ...
        {
            Area_Page.Add_Area();
            Assert.IsTrue(Area_Page.Search(Data.Place.AreaName) == "Exist", "T1_AddArea Failed");
        ...
        public void T2_EditArea()
        {
            ...
            Assert.IsTrue(Area_Page.Search(Data.Place.AreaName + "_edit") == "Exist", "T2_EditArea Failed");
        ...
        public void T3_DeleteArea()
        {
            ...
            Assert.IsTrue(Area_Page.Search(Data.Place.AreaName + "_edit") == "NotExist", "T3_DeleteArea Failed");
