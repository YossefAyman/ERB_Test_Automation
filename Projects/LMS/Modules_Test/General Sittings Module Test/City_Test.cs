...
namespace LMS_Automation_Testing
{
    ...
    class M2_General_Sittings_N3_City_Test
    {
        ...
        {
            City_Page.Add_City();
            Assert.IsTrue(City_Page.Search(Data.Place.CityName) == "Exist", "T1_AddCity Failed");
        }
        ...
        public void T2_EditCity()
        {
            ...
            Assert.IsTrue(City_Page.Search(Data.Place.CityName + "_edit") == "Exist", "T2_EditCity Failed");
        }
        ...
        public void T3_DeleteCity()
        {
            ...
            Assert.IsTrue(City_Page.Search(Data.Place.CityName + "_edit") == "NotExist", "T3_DeleteCity Failed");
        }
