 ...
 namespace LMS_Automation_Testing
{
    class Teacher_Page
    {
        ...
        internal static void add_Teacher()
        {
            throw new NotImplementedException();
        }
        ...
        public static void Add_Teacher()
        {
            ...
            time.Sleep(1000);
            Driver.FindElement(OwnerName_TextBox).SendKeys(Data.Teacher.Name);
            Driver.FindElement(OwnerEmail_TextBox).SendKeys(Data.Teacher.Email);
            Driver.FindElement(OwnerMobile_TextBox).SendKeys(Data.Teacher.Mobile);
            Driver.FindElement(OwnerAddress_TextBox).SendKeys(Data.Teacher.Address);
            Driver.FindElement(CountryList_SelectToggle).Click();
            Driver.FindElement(CountryList_TextBox).SendKeys(Data.Teacher.Country + Keys.Enter);
            Driver.FindElement(AreaList_SelectToggle).Click();
            Driver.FindElement(AreaList_TextBox).SendKeys(Data.Teacher.Area + Keys.Enter);
            Driver.FindElement(CityList_SelectToggle).Click();
            Driver.FindElement(CityList_TextBox).SendKeys(Data.Teacher.City + Keys.Enter);
            Driver.FindElement(District_SelectBox).Click();
            Driver.FindElement(District_TextBox).SendKeys(Data.Teacher.District + Keys.Enter);
            Driver.FindElement(Nationality_SelectToggle).Click();
            Driver.FindElement(Nationality_TextBox).SendKeys(Data.Teacher.Nationality + Keys.Enter);
        ...
        public static void edit_Teacher( string TeacherName, string newName)
        {

            time.Sleep(3000);
            Driver.FindElement(Search_TextBox).SendKeys(TeacherName);
        ...
        public static void delete_Teacher(string TeacherName)
        {

            time.Sleep(3000);
            Driver.FindElement(By.ClassName("ng-valid")).Clear();
            Driver.FindElement(By.ClassName("ng-valid")).SendKeys(TeacherName);
            Driver.FindElement(Search_Button).Click();
            time.Sleep(1000);
        ...
        public static void ShortKeys_Scenrio( string newName)
        {
            ...
            time.Sleep(3000);
            Driver.FindElement(Search_TextBox).SendKeys(Data.Teacher.Name);
            Driver.FindElement(Search_Button).Click();
            time.Sleep(1000);
