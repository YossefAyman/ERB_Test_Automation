...
namespace LMS_Automation_Testing
{
    public class Student_Page
    {
        ...
        public static void Add_Student_With_Full_Data()
        {
            Driver.FindElement(Add_Button).Click();
            time.Sleep(3000);
            Driver.FindElement(CustomerName_TextBox).SendKeys(Data.Student.Name);
            Driver.FindElement(CustomerEmail_TextBox).SendKeys(Data.Student.Email);
            Driver.FindElement(CustomerNumber_TextBox).SendKeys(Data.Student.Number);
            Driver.FindElement(IDType_SelectToggle).Click();
            Driver.FindElement(IDType_TextBox).SendKeys(Data.Student.ID_Type + Keys.Enter);
            Driver.FindElement(CustomerID_TextBox).SendKeys(Data.Student.ID_Number);
            Driver.FindElement(CustomerPhone_TextBox).SendKeys(Data.Student.Phone);
            Driver.FindElement(CustomerMobile_TextBox).SendKeys(Data.Student.Mobile);
            Driver.FindElement(CustomerAddress_TextBox).SendKeys(Data.Student.Address);
            Driver.FindElement(CountryList_SelectToggle).Click();
            Driver.FindElement(CountryList_TextBox).SendKeys(Data.Student.Country + Keys.Enter);
            Driver.FindElement(AreaList_SelectToggle).Click();
            Driver.FindElement(AreaList_TextBox).SendKeys(Data.Student.Area + Keys.Enter);
            Driver.FindElement(CityList_SelectToggle).Click();
            Driver.FindElement(CityList_TextBox).SendKeys(Data.Student.City + Keys.Enter);
            Driver.FindElement(District_SelectBox).Click();
            Driver.FindElement(District_TextBox).SendKeys(Data.Student.District + Keys.Enter);
            Driver.FindElement(Nationality_SelectToggle).Click();
            Driver.FindElement(Nationality_TextBox).SendKeys(Data.Student.Nationality + Keys.Enter);
        ...
        public static void Add_Student_With_Required_Data_Only()
        {
            Driver.FindElement(Add_Button).Click();
            time.Sleep(3000);
            Driver.FindElement(CustomerName_TextBox).SendKeys(Data.Student.Name);
        ...
        //#############################################################################################   
        public static void Edit_Student(string StudentName, string newName)
        {
            Search(StudentName);
            time.Sleep(1000);
        ...
        //##############################################################################################        
        public static void Delete_Student(string customerName)
        {       
            Search(customerName);
            time.Sleep(1000);
